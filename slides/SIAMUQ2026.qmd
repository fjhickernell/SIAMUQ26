...
For $\vx_0, \vx_1, \ldots \class{alert}{\IIDsim} \Unif[0,1]^d$
\begin{multline*}
...
For [carefully]{.alert} chosen $\vx_0, \vx_1, \ldots \class{alert}{\LDsim} \Unif[0,1]^d$
\begin{multline*}
...
- Theoretical guarantees for decay of discrepancy of Kronecker sequences
...
\begin{alignat*}{3}
\frac{n_-}{n_+} \Dsc(\{\vx_i\}_{i=0}^{n_--1}) - \frac{n_0}{n_+} \Dsc(\{\vx_i\}_{i=n_-}^{n_+-1}) & 
\le \Dsc(\{\vx_i\}_{i=0}^{n_+-1}) & 
\le \frac{n_-}{n_+} \Dsc(\{\vx_i\}_{i=0}^{n_--1}) +\frac{n_0}{n_+} \Dsc(\{\vx_i\}_{i=n_-}^{n_+-1}) 
\\
\frac{n_+}{n_-} \Dsc(\{\vx_i\}_{i=0}^{n_+-1}) - \frac{n_0}{n_-} \Dsc(\{\vx_i\}_{i=n_-}^{n_+-1}) &
\le \Dsc(\{\vx_i\}_{i=0}^{n_--1}) &
\le \frac{n_+}{n_-} \Dsc(\{\vx_i\}_{i=0}^{n_+-1}) + \frac{n_0}{n_-} \Dsc(\{\vx_i\}_{i=n_-}^{n_+-1}) 
\\
\frac{n_-}{n_+} \Dsc(\{\vx_i\}_{i=0}^{n_--1}) + \frac{n_0}{n_+} \Dsc(\{\vx_i\}_{i=n_-}^{n_+-1}) & 
\le \Dsc(\{\vx_i\}_{i=0}^{n_+-1}) & \le \frac{n_-}{n_+} \Dsc(\{\vx_i\}_{i=0}^{n_--1}) - \frac{n_0}{n_+} \Dsc(\{\vx_i\}_{i=n_-}^{n_+-1}) 
\\
\frac{n_+}{n_-} \Dsc(\{\vx_i\}_{i=0}^{n_+-1}) + \frac{n_0}{n_-} \Dsc(\{\vx_i\}_{i=n_-}^{n_+-1})  & \le \Dsc(\{\vx_i\}_{i=0}^{n_--1}) & \le \frac{n_+}{n_-} \Dsc(\{\vx_i\}_{i=0}^{n_+-1}) + \frac{n_0}{n_-} \Dsc(\{\vx_i\}_{i=n_-}^{n_+-1}) \\
\end{alignat*}
...
## The $n_k$ must grow at least geometrically if $p > 1$
...
a
$$
Suppose $n_{k+1} \le R n_k$ for some $R > 1$ and all $k$. Then
\begin{align*}
c n_{k+1}^{-P} & \le \Dsc(\{\vx_i\}_{i=0}^{n_{k+1}-1}) \le C n_{k+1}^{-p} \\
& \le C (R n_k)^{-p} = C R^{-p} n_k^{-p} \le C R^{-p} c n_k^{-P} \le c n_{k+1}^{-P}
\end{align*}  
