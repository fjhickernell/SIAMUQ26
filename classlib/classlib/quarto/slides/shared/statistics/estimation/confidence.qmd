...
- Identifying an [estimator]{.alert} $\Theta$ for $\theta$ that depends only on the data
- Finding the [sampling distribution]{.alert} of the estimator $\Theta$
...
- If the sample size, $n$, is [not large enough]{.alert} for the [Central Limit Theorem](../slides/01-intro.html#clt) to apply, 
